...
class binOptimalDecisionTreeClassifier:
    ...
    """
    def __init__(self, max_depth=3, min_samples_leaf=2, warmstart=True, timelimit=600, output=True):
    ...
    def _buildMIP(self, x, y):
        ...
        if self.min_samples_leaf:
            ...
            m.addConstrs(l.sum('*', t) >= self.min_samples_leaf * a[t] for t in self.l_index)
